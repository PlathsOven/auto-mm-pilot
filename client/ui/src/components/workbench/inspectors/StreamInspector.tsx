 ...
 * key-column combination (typically per symbol/expiry pair). A custom list
 * legend sits below the chart so every series stays visible (no 1/26
 * pagination) and the whole inspector body scrolls when the list is long.
 */
