...
# User-visible threshold (vol points) for the market-value-mismatch
# notification: we only alert when |totalMarketFairVol − marketVol| is at
# least this large. The card renders Δ to 2 decimal places, so sub-0.01 vp
