...
def mvi_total_vol_proportional(
    ...
    # Group rows by (symbol, expiry_str) for efficient processing
    ...
    for (symbol, expiry_str), indices in dim_groups.items():
        ...
        # Separate user-defined vs infer blocks
